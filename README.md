...
- <img src="https://raw.githubusercontent.com/oleksiijko/pmb/main/docs/assets/logo.png" height="14" /> [PMB (Personal Memory Brain)](https://github.com/oleksiijko/pmb) - Local-first persistent memory for AI coding agents over MCP. Captures decisions, lessons and facts across sessions via hybrid BM25 + vector + graph retrieval; fully offline, no API keys.
